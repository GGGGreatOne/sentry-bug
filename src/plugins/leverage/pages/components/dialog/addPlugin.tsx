...
const PluginInfo = ({
  ...
  const addHandle = useCallback(() => {
    ...
    onClose?.()
    control.hide('AddPlugin' as any)
  }, [onClose, pluginId, pluginList, updateBoxPluginListNameCallback])
  return (
    <Stack
      spacing={32}
      sx={{
...
const AddPlugin = () => {
  ...
  return (
    ...
    >
      {!!pluginId ? (
        <PluginInfo pluginData={pluginData} pluginId={pluginId} pluginName={pluginName} onClose={onClose} />
      ) : (
        <PluginList isMd={isMd} setPluginData={setPluginData} setPluginId={setPluginId} setPluginName={setPluginName} />
      )}
    </BaseDialog>
  )
}
