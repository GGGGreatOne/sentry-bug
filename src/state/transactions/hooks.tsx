...
export function useTransactionAdder(): (response: TransactionResponse, customData?: ITransactionCustomData) => void {
  ...
  return useCallback(
    (
      ...
      dispatch(addTransaction({ hash, from: account, chainId, approval, info, summary, claim, userSubmitted, nonce }))
    },
...
export function useUserHasSubmittedRecords(
  ...
  return { pending: Boolean(txn), complete: Boolean(complete), txn }
}
