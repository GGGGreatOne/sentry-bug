import { migration0 } from 'components/Widget2/state/migrations/0'
import { migration1 } from 'components/Widget2/state/migrations/1'
import { migration2 } from 'components/Widget2/state/migrations/2'
import { migration3 } from 'components/Widget2/state/migrations/3'
import { migration4 } from 'components/Widget2/state/migrations/4'
import { migration5 } from 'components/Widget2/state/migrations/5'
import { migration6 } from 'components/Widget2/state/migrations/6'
import { migration7 } from 'components/Widget2/state/migrations/7'
import { legacyLocalStorageMigration } from 'components/Widget2/state/migrations/legacy'
