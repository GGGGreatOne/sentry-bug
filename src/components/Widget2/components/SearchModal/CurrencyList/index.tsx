...
import { TokenBalances } from 'components/Widget2/lib/hooks/useTokenList/sorting'
  ...
  return (
    ...
    >
      <MenuItem
        ...
        onKeyPress={e => (e.key === 'Enter' ? onSelect(/*!!warning*/ false) : null)}
        onClick={() => onSelect(/*!!warning*/ false)}
