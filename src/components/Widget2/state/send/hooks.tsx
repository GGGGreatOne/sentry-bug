...
import { SendState } from './SendContext'
// import {
//   useUnitagByAddressWithoutFlag,
//   useUnitagByNameWithoutFlag
// } from '../../lib/uniswap/src/features/unitags/hooksWithoutFlags'
import { useCreateTransferTransaction } from '../../utils/transfer'
import { TransactionRequest } from '@ethersproject/providers'
import { useActiveWeb3React } from 'hooks'
import useENSAddress from 'components/Widget/hooks/useENSAddress'
...
export function useDerivedSendInfo(state: SendState): SendInfo {
  ...
  const validatedRecipientAddress = useMemo(() => {
    ...
    return (
      ...
      /* isAddress(recipientInputUnitagAddress) ||*/ undefined
    )
  ...
  const recipientData = useMemo(() => {
    ...
    return undefined
  }, [validatedRecipientAddress, recipientInputEnsAddress, recipient, validatedRecipientData?.ensName, ENSName])
