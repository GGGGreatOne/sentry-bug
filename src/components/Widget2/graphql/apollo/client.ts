...
import { createSubscriptionLink } from 'components/Widget2/lib/utils/apollo/SubscriptionLink'
import { splitSubscription } from 'components/Widget2/lib/utils/apollo/splitSubscription'

const API_URL = process.env.NEXT_PUBLIC_REACT_APP_AWS_API_ENDPOINT
const REALTIME_URL = process.env.NEXT_PUBLIC_REACT_APP_AWS_REALTIME_ENDPOINT
const REALTIME_TOKEN = process.env.NEXT_PUBLIC_REACT_APP_AWS_REALTIME_TOKEN
