...
const Education = ({ data }: { data: IBoxAboutSectionTypeExperienceValue }) => {
              ...
              >
                {item.picture ? (
                  ...
                  <Stack alignItems={'center'} justifyContent={'center'} width={isMd ? 60 : 76} height={isMd ? 60 : 76}>
                    <EducationIcon style={{ margin: '0 auto' }} />
                  </Stack>
                )}
              </Box>
              <Stack width={'88%'} gap={6} flexDirection={'column'} alignItems={'center'}>
                <Typography
                  variant="h3"
                  noWrap
                  sx={{
