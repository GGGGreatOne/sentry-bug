...
import { Friendlist, FriendlistItem } from 'api/user/type'
...
const FollowerCarItem = ({
  ...
  const { avatar, projectName, boxId, rewardId, description, followCount } = item
  return (
    <ItemComtainer
      onClick={event => {
